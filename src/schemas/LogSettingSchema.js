...
const LoggerSettingSchema = new mongoose_1.Schema({
    guild_id: String,
...
const LoggerSetting = (0, mongoose_1.model)('LogChannel', LoggerSettingSchema, 'LogChannel');
exports.default = LoggerSetting;
