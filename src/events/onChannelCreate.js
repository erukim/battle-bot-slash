...
exports.default = new Event_1.Event('channelCreate', (client, channel) => __awaiter(void 0, void 0, void 0, function* () {
    const LoggerSettingDB = yield LogSettingSchema_1.default.findOne({
        guild_id: channel.guild.id
    });
    if (!LoggerSettingDB)
        return;
    if (!LoggerSettingDB.useing.createChannel)
        return;
    ...
    const embed = new Embed_1.default(client, 'success').setTitle('채널 생성').addFields({
        name: '채널',
