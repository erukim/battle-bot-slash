...
exports.client = new BotClient_1.default(config_1.default.bot.options);
const command = new CommandManager_1.default(exports.client);
const event = new EventManager_1.default(exports.client);
const database = new DatabaseManager_1.default(exports.client);
const button = new ButtonManager_1.default(exports.client);
command.load(path_1.default.join(__dirname, 'commands'));
event.load(path_1.default.join(__dirname, 'events'));
button.load(path_1.default.join(__dirname, 'buttons'));
database.load();
exports.client.start(config_1.default.bot.token);
