...
exports.default = new Command_1.BaseCommand({
    ...
    let result = (yield client.player
    ...
    if (result.playlist) {
        ...
        let msg = yield message.reply({
            content: `<:playing:941212508784586772> **${(0, builders_1.userMention)(message.author.id)} 노래를 선택해주세요!**`,
            components: [row]
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.playlist) {
                ...
                interaction.editReply({
                    content: `<:playing:941212508784586772> **${(0, builders_1.userMention)(interaction.user.id)} 노래를 선택해주세요!**`,
                    components: [row]
                });
