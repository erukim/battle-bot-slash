...
class ErrorManager extends BaseManager_1.default {
    ...
    report(error, options) {
        ...
        isSend ? executer === null || executer === void 0 ? void 0 : executer.reply({ embeds: [errorEmbed] }) : null;
        if (config_1.default.report.type == 'webhook') {
            const webhook = new discord_js_1.default.WebhookClient({
            ...
            channel === null || channel === void 0 ? void 0 : channel.send(errorText);
        }
    }
}
